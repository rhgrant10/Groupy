...
class PagerTests(unittest.TestCase):
    def setUp(self):
        ...
        self.m_manager._raw_list.side_effect = ['abc', 'xyz']
        self.params = {'x': 42}
        self.pager = pagers.Pager(self.m_manager, **self.params)
    ...
    def test_params_passed(self):
        __, kwargs = self.m_manager._raw_list.call_args
...
class GroupListTests(unittest.TestCase):
    def setUp(self):
        self.groups = pagers.GroupList(mock.Mock())
...
class MessageListTests(unittest.TestCase):
    def setUp(self):
        ...
        self.m_manager._raw_list.side_effect = pages
        self.messages = pagers.MessageList(self.m_manager)
