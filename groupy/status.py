...
def description(code):
	return {
		...
		BAD_REQUEST: 'Invalid format or invalid data is specified in the request',
		...
		NOT_FOUND: 'The URI requested is invalid or the requested resource does not exist',
		...
		SERVICE_UNAVAILABLE: 'The GroupMe servers are up but overloaded with requests'
	}.get(code, '!Unknown!')
